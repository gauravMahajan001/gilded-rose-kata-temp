...
class ItemSpecificNameTest {
	...
	@DisplayName("should return true when item name  matched")
	@Test
	void testSpecficItemNameMatchWithGivenName() {

		Item item = new Item("Test", 2, 2);
		String itemNameMatch = "Test";

		Boolean result = itemSpecificNameImpl.isSpecficItemNameMatchWithGivenName(item, itemNameMatch);
		assertEquals(Boolean.TRUE, result);

	}
	
	@DisplayName("should return false when item name not matched")
	@Test
	void testSpecficItemNameNotMatchWithGivenNameThenReturnFalse() {

		Item item = new Item("Test", 2, 2);
		String itemNameMatch = "Temp";
